...
#         print(1111111111111111111111)
        ...
        # print(attn_weights[0,0,0:16])te
...
#         print('?'*100)
#         print(v.shape)
# #         print(bsz, self.num_heads, src_len, self.head_dim)
#         v_cat = v.view(bsz, self.num_heads, src_len, self.head_dim).transpose(1, 2).contiguous().view(bsz, src_len, self.num_heads*self.head_dim)
# #         print('='*100)
# #         print(v_cat.shape)
# #         print(src_len)
# #         print(tgt_len)
...
# #         print('x'*100)
#         f_x = v_cat.matmul(self.out_proj.weight.transpose(0, 1))
# #         f_x = v_cat.matmul(self.out_proj.weight)
# #         print(f_x.shape)
#         f_x_norm = torch.norm(f_x, dim=2)
# #         print(f_x_norm[:,0:400])
#         f_x_norm = f_x_norm.repeat(self.num_heads*tgt_len,1).view(bsz, self.num_heads, tgt_len, src_len)
#         print(f_x_norm.shape)
        # 需要将f_x转换为模，参考他自己的源码
...
#         print(attn_weights)
#         attn_weights = attn_weights.div(f_x_norm)
#         print(attn_weights)
#         print(attn_weights.shape)
#         exit(0)
        # print(attn_probs.shape)
