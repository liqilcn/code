...
if __name__ == "__main__":
    ...
    flags.add_argument('-batch_size',          default=6,    type=int)
    flags.add_argument('-gradient_accumulation_steps', default=1, type=int)
    flags.add_argument('-lr',                  default=2e-4,  type=float)
    ...
    train_dataset = T5Dataset(args, config=model_config, tokenizer=tokenizer, mode='train', dataset_path=args.dataset_path)
    valid_dataset = T5Dataset(args, config=model_config, tokenizer=tokenizer, mode='valid', dataset_path=args.dataset_path)
