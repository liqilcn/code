...
def save_test_res(test_dir, init_model_path):
    # print(test_dir)
    model_config = T5Config.from_pretrained(init_model_path, local_files_only=True)
    ...
    with torch.no_grad():
        ...
        report = {'fpr95':fpr95, 'auc':auc, 'aupr':aupr}
    #     print(report)
    # return report
...
def get_auc_dir(model_data_path,init_model_pth):
    ...
    res, rdir = save_test_res(selected_dir,init_model_pth)
    return res, rdir
